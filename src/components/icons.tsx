...
const P = {
  ...
  broom: (
    <>
      <path d="m13.2 2.8-4.6 4.6" />
      <path d="M8.9 7.1 4.6 8.9a5.6 5.6 0 0 0-2.4 4.3l.4.4a5.6 5.6 0 0 0 4.4-2.2l2-4.2z" />
    </>
  ),
  bell: (
    <>
  ...
  paperclip: <path d="m12.8 7.2-4.9 4.9a3 3 0 0 1-4.2-4.2l5.3-5.3a2 2 0 0 1 2.8 2.8L6.6 10.6a1 1 0 0 1-1.4-1.4l4.5-4.5" />,
